...
const COLUMN_STYLES: Record<string, { bg: string; headerBg: string; border: string; count: string }> = {
  ...
  discussion_needed:  { bg: 'bg-orange-50', headerBg: 'bg-orange-100', border: 'border-orange-200', count: 'bg-orange-200 text-orange-800' },
  questions:          { bg: 'bg-cyan-50',   headerBg: 'bg-cyan-100',   border: 'border-cyan-200',  count: 'bg-cyan-200 text-cyan-800' },
